...
3. **Save the File**  
   Pick a folder on your computer, like `Downloads` or `Desktop`, and save the file there.
...
### Creating a Scheduled AI Task  
1. Click **New Task**  
2. Type what the task should do  
3. Choose the AI skill or agent (like Claude)  
4. Set how often the task runs  
5. Save and activate
...
- Replace your old `ductwork.exe` file by saving the new one in the same folder.  
- Running the new file updates the program without extra steps.  
